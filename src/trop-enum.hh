...
auto as_integer(Enum const value) -> typename std::underlying_type<Enum>::type {
  return static_cast<typename std::underlying_type<Enum>::type>(value);
}

// print a vector of Tropicity's as integers
template <typename Enum>
auto vec_as_integer(const vector<Enum>& values) -> vector<typename std::underlying_type<Enum>::type> {
